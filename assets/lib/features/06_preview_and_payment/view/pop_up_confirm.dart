        ...
        const Text(
          ...
          style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),
            ...
            Container(
                margin: const EdgeInsets.symmetric(horizontal: 120),
                width: double.infinity,
                child: RectangleButton2(onTap: (){}, text: '常見問題', textSize: 19, fontWeight: FontWeight.w500,backgroundColor: Pallete.greyColor,padding: const EdgeInsets.symmetric(vertical: 10))),
